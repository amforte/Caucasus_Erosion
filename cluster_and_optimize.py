...
# plt.subplot(4,2,2)
# for i in range(num_clustw):
#     plt.scatter(cw[kmw.labels_==i],mR[kmw.labels_==i],c=color_list[i])
# plt.xlabel('Shape')
# plt.ylabel('Mean Runoff [mm/day]')
# plt.title('Weibull Whole')

# plt.subplot(4,2,4)
# for i in range(num_clustw):
#     plt.scatter(sw[kmw.labels_==i],mR[kmw.labels_==i],c=color_list[i])
# plt.xlabel('Scale')
# plt.ylabel('Mean Runoff [mm/day]')

# plt.subplot(4,2,6)
# for i in range(num_clustw):
#     plt.scatter(mR[kmw.labels_==i],maxZ[kmw.labels_==i],c=color_list[i])
# plt.scatter(emR,emaxZ,c='gray',zorder=0,marker='s',s=20,alpha=0.5)
# plt.xlabel('Mean Runoff [mm/day]')
# plt.ylabel('Max Elevation [km]')
...
#     lldf=pd.read_csv('temp_GRDC_outlines/Bsn_'+str(ID[i])+'.csv')
#     lab=kmw.labels_[i]
#     for j in range(num_clustw):
#         if lab==j:
#             plt.fill(lldf['Lon'],lldf['Lat'],c=color_list[j],zorder=0,alpha=0.5)
# plt.scatter(ex,ey,s=10,c='gray',zorder=2,marker='s',alpha=0.5)
# plt.xlabel('Longitude')
# plt.ylabel('Latitude')
# plt.gca().set_aspect('equal', adjustable='box')    